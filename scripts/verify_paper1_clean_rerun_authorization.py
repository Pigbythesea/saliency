...
CLEAN_RUNNER_REQUIREMENTS = {
    "behavioral": {
        "config": "configs/paper1_clean_behavioral_rerun.yaml",
        "runner": "scripts/run_paper1_clean_behavioral_rerun.py",
        "expected": "outputs/paper1_publication_v0/behavioral/aggregate.csv",
    },
