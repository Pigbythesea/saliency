...
- Behavioral bridge CSV: D:\Git\saliency\.tmp_pytest_neural_summary_impl\test_behavior_neural_leader_ov0\behavior.csv.
...
- Matched full-image `flatten_pca` panel models complete in summary: 0.
- Matched geometry model-ranking rows: 0.

## Best Encoding Layers

- fast_model subj01 V1 correlation: layer2 score=0.2. score_type=raw.
- slow_model subj01 V1 correlation: layer2 score=0.2. score_type=raw.

## Best RSA Layers

- fast_model subj01 V1 spearman: layer3 score=0.07.
- slow_model subj01 V1 spearman: layer3 score=0.07.
...
- No complete matched full-image `flatten_pca` rows are available yet.
