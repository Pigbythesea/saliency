...
- Strongest mean ROI500 noise-normalized encoding model: vit_small_patch14_dinov2 (0.9; x100=90).
- Strongest mean ROI500 raw encoding model: vit_small_patch14_dinov2 (0.7).
- Strongest mean ROI500 RSA model: vit_small_patch14_dinov2 (0).
