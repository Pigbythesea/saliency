...
- Behavior-neural alignment rows: 1.
- Matched cross-level correlation rows: 0.
- Behavioral CSV: D:\Git\saliency\.tmp_pytest_neural_summary_impl\test_behavior_neural_bridge_in0\results_with_ssl_behavior.csv.
...
- Strongest mean ROI500 raw encoding model: vit_small_patch14_dinov2 (0.2).
- Strongest mean ROI500 RSA model: vit_small_patch14_dinov2 (0.07).
