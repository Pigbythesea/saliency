...
- Behavioral bridge CSV: D:\Git\saliency\.tmp_pytest_neural_summary_impl\test_matched_cross_level_analy0\behavior.csv.
...
- convnext_tiny subj01 V1 correlation: layer2 score=0.9. score_type=noise_normalized.
- deit_small_patch16_224 subj01 V1 correlation: layer2 score=0.6. score_type=noise_normalized.
- resnet50 subj01 V1 correlation: layer2 score=0.9. score_type=noise_normalized.
...
- Matched cross-level observation rows: 18.
- Matched cross-level correlation/regression groups: 6/6 complete.
...
- Matched learned-readout and `flatten_pca` comparison rows: 1; raw-score improvements: 1/1.
