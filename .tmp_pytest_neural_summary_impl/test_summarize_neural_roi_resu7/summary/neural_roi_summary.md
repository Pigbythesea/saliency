...
- Input directories: 1.
- Encoding rows: 2.
- Encoding target rows: 2.
- RSA rows: 2.
- Geometry rows: 0 matched rows.
- Behavioral bridge CSV: not provided.
- Efficiency CSV: not provided.
- Benchmark-style encoding scope: mixed target-level scope (benchmark_style_noise_normalized=1, benchmark_style_non_noise_normalized=1).
...
- resnet50 subj01 hV4 correlation: layer2 score=0.32. score_type=noise_normalized.

## Best RSA Layers

- resnet50 subj01 hV4 spearman: layer3 score=0.07.
