...
- Model/ROI winner rows: 1.
- Model ranking rows: 1.
...
- Strongest mean ROI500 raw encoding model: resnet50 (0.2).
- Strongest mean ROI500 RSA model: resnet50 (0.07).
...
- Candidate inventory CSV: D:\Git\saliency\.tmp_pytest_neural_summary_impl\test_multimodel_note_reports_p0\summary\ssl_multimodal_candidate_inventory.csv.
- Dry-inspected compatible candidates: 2/2.
- Pretrained debug runs complete: 1.
- Pretrained status counts: complete=1, not_run=1.
